...
@SourceType(value = "InstagramARP", label = "Instagram",uiConfig = "instagram-layout.json")
public class InstagramConf extends AbstractArpConf<InstagramConf> {
  private static final String ARP_FILENAME = "arp/implementation/instagram-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.instagram.InstagramDriver";
